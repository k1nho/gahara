...
func (a *App) InsertInterval(rid string, start, end float64, pos int) error {
...
func (a *App) SplitInterval(pos int, start, end float64) ([]video.VideoNode, error) {
	return a.Timeline.Split(pos, start, end)
}
