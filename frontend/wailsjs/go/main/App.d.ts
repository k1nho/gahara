...
export function InsertInterval(arg1:string,arg2:number,arg3:number,arg4:number):Promise<void>;
...
export function SplitInterval(arg1:number,arg2:number,arg3:number):Promise<Array<video.VideoNode>>;
